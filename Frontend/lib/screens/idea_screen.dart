...
class IdeaStream extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // TODO: 6. Initialize the StreamBuilder to listen to the 'dataBoard' collection
    final docsSnapshot = FirebaseFirestore.instance.collection('dataBoard').orderBy('createdAt', descending: true).snapshots();
...
class IdeaWidget extends StatelessWidget {
  ...
  Future<void> deleteIdea(String id) async {
     await FirebaseFirestore.instance.collection('dataBoard').doc(id).delete(); 
  } 
